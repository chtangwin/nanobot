...
Usage:
    ...
    uv run python tests/webfetch/benchmarks.py

    # With JSON output
    uv run python tests/webfetch/benchmarks.py --output report.json

    # Quiet mode (summary only)
    uv run python tests/webfetch/benchmarks.py --quiet
