...
Usage examples:
  uv run python scripts/web_fetch_robust.py "https://example.com"
  uv run python scripts/web_fetch_robust.py "https://example.com" --json
  uv run python scripts/web_fetch_robust.py "https://airank.dev" --mode discovery --json
"""
