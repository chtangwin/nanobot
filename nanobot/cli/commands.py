...
def gateway(
    ...
    agent = AgentLoop(
        ...
        block_sensitive_files=config.tools.block_sensitive_files,
        redact_tool_outputs=config.tools.redact_tool_outputs,
        redact_context=config.tools.redact_context,
